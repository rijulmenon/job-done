      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Fill in your details and upload your resume to get an honest AI
        ...
        {result ? (
          <div>
            ...
            <button
              onClick={handleReset}
              className="mt-6 w-full border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white font-medium py-3 rounded-xl transition-colors"
            >
          ...
          >
            ...
            <div>
              ...
              {!fileName ? (
                ...
                >
                  {pdfLoading ? (
                    <div className="flex flex-col items-center gap-2">
                      <svg
                        className="animate-spin h-6 w-6 text-sky-400"
                        viewBox="0 0 24 24"
                        fill="none"
                      >
                        <circle
                ...
                <div className="flex items-center justify-between bg-slate-800 border border-slate-700 rounded-xl px-4 py-3">
                  ...
                  <button
                    ...
                    className="text-slate-500 hover:text-red-400 transition-colors ml-3 flex-shrink-0"
              ...
              {pdfError && (
                <p className="mt-2 text-red-400 text-sm bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2">
                  {pdfError}
                </p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading || pdfLoading || !resumeText}
              className="w-full bg-sky-500 hover:bg-sky-400 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-xl transition-colors text-lg"
            >
              {loading ? (
